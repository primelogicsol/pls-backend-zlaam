...
export const userRegistrationSchema = z.object({
  ...
  email: z
    ...
    .min(1, { message: "email is required!!" }).max(150, { message: "email can be at most 150 characters long. e.g: john.doe@example.com" })
  ...
  password: z
    ...
    .min(6, { message: "password must be at least 6 characters long." }).max(50, { message: "password can be at most 50 characters long." })
});
...
export const userLoginSchema = z.object({
  email: z
    .string({ message: "email is required!!" })
    .min(1, { message: "email is required!!" }).email({ message: "Invalid email format. e.g: john.doe@example.com" }),
  password: z
    .string({ message: "password is required!!" })
    .min(1, { message: "password is required!!" })
});
